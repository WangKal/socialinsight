              ...
              <AnimatePresence>
                {messages.map((msg, idx) => (
                  ...
                  >
                    ...
                    {normalized.username?.[0]?.toUpperCase() || "U"}
                  </div>
                                        <div className="flex-1 min-w-0">
                                          <div className="flex items-center gap-2 mb-1">
                                            ...
                                            {normalized.timestamp && (
                                              <span className="text-xs text-gray-500">{normalized.timestamp}</span>
                                            )}
                                          </div>
                                          <p className="text-xs text-gray-700 line-clamp-2">{normalized.text}</p>
                                        </div>
                                      </div>
                                      <button
